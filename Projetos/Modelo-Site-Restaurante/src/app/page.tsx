            ...
            <div className="position-relative w-100 vh-100 overflow-hidden">
                ...
                <div className="position-relative d-flex align-items-center justify-content-center h-100 text-dark" style={{zIndex: 10}}>
                    <div className="text-center">
                        <h1 className="display-1 fw-bold mb-4 text-white" style={{textShadow: '4px 4px 16px rgba(0,0,0,0.7)'}}>Restaurante</h1>
                        <p className="fs-3 text-white" style={{textShadow: '2px 2px 6px rgba(0,0,0,0.6)'}}>Uma Nova Experiência Gastronômica</p>
                    </div>
                </div>
            </div>
        </>
